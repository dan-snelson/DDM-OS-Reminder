...
| `{scriptVersion}` | System | Script version | 4.2.0b2 |
...
|---------|------|---------|
| 4.2.0b2 | 08-Sep-2026 | Broadened DDM Emergency Fallback eligibility across recognized unresolved resolver states; no preference keys or preference precedence rules changed |
...
**DDM OS Reminder Version**: 4.2.0b2

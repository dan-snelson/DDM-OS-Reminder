...
**Locale Behavior (3.0.0+, expanded in 3.3.0b3)**:
...
| `{scriptVersion}` | System | Script version | 3.3.0b3 |
...
| 3.3.0b3 | 14-May-2026 | Added region-aware `DateFormatDeadlineHumanReadableLocalized_<code>` overrides with exact locale -> base language -> global fallback behavior, plus matching relative `Today` / `Tomorrow` time-format guidance |
...
**DDM OS Reminder Version**: 3.3.0b3

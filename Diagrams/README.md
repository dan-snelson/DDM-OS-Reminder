# DDM OS Reminder (4.0.0b13) - Documentation Diagrams
...
| 1.0.7 | 14-May-2026 | Documented `4.0.0b13` region-aware deadline date-format fallback keys, exact/base locale resolution behavior, and aligned relative-deadline time rendering guidance |

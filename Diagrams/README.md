...
|---------|------|---------|
| 1.0.7 | 13-May-2026 | Documented `3.3.0b1` region-aware deadline date-format fallback keys, exact/base locale resolution behavior, and aligned relative-deadline time rendering guidance |

# DDM OS Reminder (3.3.0b1) - Documentation Diagrams
...
|---------|------|---------|
| 1.0.6 | 06-Apr-2026 | Refreshed diagram documentation for the `3.3.0b1` release, including final-version metadata, current localization behavior, `VersionString`-based compliance fallback when `BuildVersionString` is unavailable, and bundled EA fixture-hook guidance |

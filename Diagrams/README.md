...
| 1.0.7 | 14-May-2026 | Documented `4.0.0b14` region-aware deadline date-format fallback keys, exact/base locale resolution behavior, and aligned relative-deadline time rendering guidance |

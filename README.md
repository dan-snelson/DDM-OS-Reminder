...
# DDM OS Reminder
> A maintenance release to Mac Admins’ new favorite, MDM-agnostic, **“set-it-and-forget-it”** end-user reminder for Apple’s Declarative Device Management-enforced macOS update deadlines **that further simplifies enterprise-wide deployment** and adds new features like **excessive uptime** and **low disk space** alerts

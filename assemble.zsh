...
# customized end-user message into launchDaemonManagment.zsh by executing:
#
# zsh assemble.zsh
#
...
scriptDir="$(cd "$(dirname "${0}")" && pwd)"    # DDM-OS-Reminder/
baseScript="${scriptDir}/launchDaemonManagment.zsh"
messageScript="${scriptDir}/reminderDialog.zsh"
timestamp="$(date '+%Y-%m-%d-%H%M%S')"
outputScript="${scriptDir}/launchDaemonManagment.Assembled.${timestamp}.zsh"

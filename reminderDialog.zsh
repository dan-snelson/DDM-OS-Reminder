...
declare -A preferenceConfiguration=(
    ...
    ["supportAssistanceMessageLocalizedDe"]="string|<br><br>Bei Fragen wende dich über die (?) Schaltfläche unten rechts an **{supportTeamName}**."
    ...
    ["stagedUpdateMessageLocalizedDe"]="string|<br><br>**Gute Nachricht!** Das macOS-{ddmVersionString}-Update wurde bereits auf deinem Mac geladen und ist bereit zur Installation. Die Installation geht schneller, wenn du auf **{button1text}** klickst."
    ...
    ["messageLocalizedDe"]="string|**Eine erforderliche macOS-{titleMessageUpdateOrUpgrade:l} ist jetzt verfügbar**<br><br>Hallo {loggedInUserFirstname}!<br><br>Bitte führe die {titleMessageUpdateOrUpgrade:l} auf macOS **{ddmVersionString}** durch, damit dein Mac sicher bleibt und den Richtlinien entspricht.{updateReadyMessage}<br><br>Um die {titleMessageUpdateOrUpgrade:l} jetzt zu starten, klicke auf **{button1text}**, folge den Hinweisen auf dem Bildschirm und klicke anschliessend auf **{softwareUpdateButtonText}**.<br><br>Wenn du die {titleMessageUpdateOrUpgrade:l} jetzt nicht durchführen kannst, klicke auf **{button2text}**, um später erinnert zu werden (diese Option ist kurz vor der Frist deaktiviert).<br><br>{deadlineEnforcementMessage}{excessiveUptimeWarningMessage}{diskSpaceWarningMessage}{supportAssistanceMessage}"
